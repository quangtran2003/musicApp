      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Obx(() => controller.playlistData.value != null
                ? Container(
              ...
              if (controller.playlistData.value == null) {
                ...
                return Expanded(
                  child: Padding(
                    ...
                    child: ListView.builder(
                        itemCount:
                            controller.playlistData.value?.tracks?.data?.length,
                        itemBuilder: ((context, index) {
                          return GestureDetector(
                            onTap: () {
                              ...
                              Get.toNamed(PLAY_MUSIC_SCREEN, arguments: {
                                'songId': controller.playlistData.value?.tracks
                                    ?.data?[index].id,
                                'listTrack': controller.tracks.value,
                                'listIdSong': controller.listIdSong
                              });
                            ...
                            child: MySong(
                                title: controller.playlistData.value?.tracks
                                    ?.data?[index].title,
                                subTitle: controller.playlistData.value?.tracks
                                    ?.data?[index].artist?.name,
                                url: controller.playlistData.value?.tracks
