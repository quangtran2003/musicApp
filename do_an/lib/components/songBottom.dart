...
class SongBottom extends StatelessWidget {
  const SongBottom({
    super.key,
  });
      ...
      onTap: () {
        if (controller.trackData.value?.title != null) {
          Get.toNamed(PLAY_MUSIC_SCREEN,
              arguments: ModelSongTransfer(isSongBottom: true));
        }
      },
      child: Obx(
                ...
                child: ListTile(
                  leading: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: controller.trackData.value?.album?.coverSmall !=
                                null
                            ? DecorationImage(
                                ...
                                fit: BoxFit.cover)
                            : DecorationImage(
                                image: AssetImage('assets/bgSong.png'),
                                fit: BoxFit.cover)),
                  ),
                  trailing: Row(
